...
public class TransactionController {
    ...
    @PostMapping
    public String create(@RequestBody TransactionRequest transactionRequest, @RequestHeader("Authorization") String authHeader) {
    ...
    @PutMapping("/{id}")
    public String update(@PathVariable Long id, @RequestBody TransactionRequest transactionRequest, @RequestHeader("Authorization") String authHeader) {
        String token = authHeader.replace("Bearer ", "");
